...
class CDQNAgent(TFAAgent):
  """Categorical_DQN-Agent
  ...
  def get_agent(self, env, params):
    """Returns a TensorFlow Categorical_DQN-Agent
    ...
    categorical_q_net = categorical_q_network.CategoricalQNetwork(
        ...
        env.action_spec(),
        num_atoms=self._params["ML"]["DQNAgent"]["num_atoms", "", 51],
        fc_layer_params=tuple(
          self._params["ML"]["DQNAgent"]["categorical_fc_layer_params", "", [300, 300, 300]]))
    ...
    tf_agent = categorical_dqn_agent.CategoricalDqnAgent(
      ...
      min_q_value=self._params["ML"]["DQNAgent"]["min_q_value", "", -10],
      max_q_value=self._params["ML"]["DQNAgent"]["max_q_value", "", 10],
      epsilon_greedy=self._params["ML"]["DQNAgent"]["epsilon_greedy", "", 0.3],
      n_step_update=self._params["ML"]["DQNAgent"]["n_step_update", "", 2],
  ...
  def get_replay_buffer(self):
    ...
    return tf_uniform_replay_buffer.TFUniformReplayBuffer(
      ...
      max_length=self._params["ML"]["DQNAgent"]["replay_buffer_capacity", "", 10000])
  ...
  def get_dataset(self):
    ...
    dataset = self._replay_buffer.as_dataset(
      ...
      num_steps=self._params["ML"]["DQNAgent"]["n_step_update", "", 2]+1) \
